    ...
    >
      <v-card class="text-center mb-0" width="300">
        <v-card-text>
          ...
          <!-- <strong class="mb-3 d-inline-block">访问官网</strong>
          <v-btn
            color="info"
            href="https://www.yanei-iot.com/"
            default
            rel="noopener"
            target="_blank"
            text
          ...
          <strong class="mb-3 d-inline-block">微信公众号</strong>
          <v-icon right color="success">mdi-wechat</v-icon>
        </v-card-text>
      </v-card>
    </v-menu>
  </div>
...
export default {
  ...
  data: () => ({
    ...
    menu: false,
    saveImage: '',
    scrim: 'rgba(50, 50, 50, .7), rgba(50, 50, 50, .7)',
    scrims: [
      'rgba(50, 50, 50, .7), rgba(50, 50, 50, .7)',
