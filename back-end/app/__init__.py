...
def configure_app(app, config_class):
    ...
    # app.task_queue = rq.Queue('yanei-tasks', connection=app.redis, default_timeout=3600)  # 设置任务队列中各任务的执行最大超时时间为 1 小时
    # Elasticsearch全文检索
    ...
    if not app.debug and not app.testing:
        if app.config['LOG_TO_STDOUT']:
            ...
            if not os.path.exists('logs'):
                os.mkdir('logs')
            file_handler = RotatingFileHandler('logs/yanyi.log',
